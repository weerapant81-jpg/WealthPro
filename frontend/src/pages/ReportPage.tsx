    ...
    if (kind === 'ack2') {
      ...
      return (
        <div style={{ marginBottom: 8 }}>
          <H t="คำรับทราบ" />
          <P>โปรดทราบว่า คำแนะนำในแผนฉบับนี้จัดทำขึ้นจากข้อมูลที่ได้รับและสมมติฐานที่ใช้ ซึ่งสรุปไว้ในส่วนสมมติฐานของแผน ควรทบทวนคำแนะนำเหล่านี้เป็นระยะ เนื่องจากอาจเปลี่ยนแปลงตามสถานการณ์ส่วนบุคคล สถานะทางการเงิน และสภาวะตลาดที่เปลี่ยนแปลงไปตามเวลา</P>
          <H t="ข้อเปิดเผยข้อมูล" />
          <P><U v={advName} /> เป็นที่ปรึกษาการเงิน ที่ผ่านการฝึกอบรมการใช้งานโปรแกรม WealthPro มาแล้ว จึงจะมีสิทธิ์ในการใช้งานโปรแกรมนี้ เพื่อวางแผนการเงินให้กับบุคคลทั่วไป ได้อย่างถูกต้องตามหลักการวางแผนการเงิน CFP</P>
          <P>เอกสารนำเสนอนี้มีข้อมูลที่อาจไม่เหมาะสมสำหรับทุกคน และจัดทำขึ้นเพื่อเผยแพร่ข้อมูลทั่วไปเกี่ยวกับการวางแผนการเกษียณอายุให้แก่ลูกค้าด้านการบริหารความมั่งคั่งและการบริหารการลงทุนของ <U v={clName} /> เท่านั้น ไม่มีการรับประกันว่ามุมมองและความคิดเห็นที่แสดงไว้ในเอกสารนี้จะเป็นจริง ห้ามตีความเนื้อหาในเอกสารนี้ว่าเป็นคำแนะนำด้านกฎหมาย ภาษี หรือบัญชี การลงทุนในหุ้นและตลาดอื่น ๆ มีทั้งโอกาสได้รับกำไรและความเสี่ยงที่จะขาดทุน และอาจไม่เหมาะสมกับผู้ลงทุนทุกคน ข้อมูลที่นำเสนออาจเปลี่ยนแปลงได้โดยไม่ต้องแจ้งให้ทราบ และไม่ควรถือเป็นการชักชวนให้ซื้อหรือขายหลักทรัพย์ใด ๆ หรือเข้าร่วมการลงทุนหรือกลยุทธ์อื่นใด สำหรับเรื่องที่เกี่ยวข้องกับกฎหมาย ภาษี และบัญชี เราขอแนะนำให้ท่านขอคำปรึกษาจากทนายความหรือนักบัญชีที่มีคุณสมบัติเหมาะสม ผู้ลงทุนควรปรึกษาที่ปรึกษาทางการเงินก่อนตัดสินใจลงทุน ข้อมูลในเอกสารนี้จัดทำขึ้นตามมาตรฐานการวางแผนการเงิน CFP ที่เราเชื่อว่าน่าเชื่อถือ แต่ไม่ควรสันนิษฐานว่าข้อมูลดังกล่าวถูกต้องหรือครบถ้วน</P>
          <P>ข้อมูลเกี่ยวกับผลการดำเนินงานของตลาดในอดีต มีไว้เพื่อประกอบการอธิบายและเพื่อการศึกษาเท่านั้น โดยไม่สะท้อนการหักค่าธรรมเนียมธุรกรรม ค่าดูแลทรัพย์สิน หรือค่าธรรมเนียมการบริหารการลงทุน ซึ่งจะทำให้ผลการดำเนินงานในอดีตลดลง โปรดอย่าสันนิษฐานว่าผลการดำเนินงานในอนาคตจะเท่ากับหรือสูงกว่าผลการดำเนินงานในอดีต และ/หรือค่าเฉลี่ย</P>
          <P>สมมติฐานที่ใช้ในการวางแผนจัดทำขึ้นจากข้อมูลที่ท่านมอบให้ หรือข้อมูลที่ท่านปฏิเสธที่จะมอบให้ และเป็นพื้นฐานของสถานการณ์จำลองของท่าน โปรดทราบว่าสมมติฐานที่ใช้ รวมถึงสมมติฐานเกี่ยวกับกระแสเงินสด ผลตอบแทนจากการลงทุน อัตราเงินเฟ้อ และตัวชี้วัดอื่น ๆ จะเปลี่ยนแปลงคำแนะนำเหล่านี้ การคาดการณ์หรือข้อมูลอื่น ๆ ที่ Monte Carlo สร้างขึ้นเพื่อวิเคราะห์ความเป็นไปได้ของผลลัพธ์การลงทุนต่าง ๆ เป็นข้อมูลเชิงสมมติฐาน และไม่ได้สะท้อนผลการลงทุนที่เกิดขึ้นจริงหรือเป็นหลักประกันผลลัพธ์ในอนาคต การเปลี่ยนแปลงเพียงเล็กน้อยของตัวแปรที่นำเข้าอาจส่งผลให้ผลลัพธ์ในกระบวนการ Monte Carlo เปลี่ยนแปลงอย่างมาก การวิเคราะห์แบบ Monte Carlo มีประโยชน์สำหรับการวิเคราะห์เชิงเปรียบเทียบ ไม่ใช่สำหรับการประเมินค่าหรืออัตราความสำเร็จที่แน่นอน ผลลัพธ์อาจแตกต่างกันในแต่ละครั้ง ระบบจำลอง Monte Carlo เป็นแนวทางเชิงกำหนดที่ใช้ข้อมูลในอดีตเป็นแนวทางในการประมาณผลตอบแทนของพอร์ตการลงทุนในอนาคต การคำนวณที่เกี่ยวข้องอาจได้รับผลกระทบอย่างมาก หากตัวแปรที่ใช้เป็นสมมติฐาน เช่น เงินทุนที่เพิ่มเข้ามา จำนวนเงินที่ถอน อัตราเงินเฟ้อ อัตราผลตอบแทนที่คาดหวัง และ/หรืออัตราภาษี แตกต่างไปจากที่คาดการณ์ไว้</P>
          <P>รายงานฉบับต่อไปนี้เป็นเครื่องมือวิเคราะห์ที่มีจุดประสงค์เพื่อทบทวนสถานะทางการเงินในปัจจุบันของท่าน และเสนอแนวคิดหรือแนวทางการวางแผนที่อาจเป็นประโยชน์ จุดประสงค์ของรายงานคือเพื่อแสดงให้เห็นว่า การวางแผนทางการเงินและการวางแผนมรดกที่เป็นที่ยอมรับอาจช่วยส่งเสริมสถานการณ์ของท่านได้อย่างไร</P>
