...
const GROUPS: Group[] = [
  ...
  },
  {
    icon: ShieldCheck, title: 'ความปลอดภัย & PDPA', items: [
      ...
      { q: 'เปิด 2FA (ยืนยัน 2 ชั้น)', a: <>หน้า "ปรับแต่งข้อมูลผู้ใช้" → การ์ด <B>ยืนยันตัวตน 2 ชั้น</B> → สแกน QR ด้วยแอป Authenticator → เก็บรหัสสำรองไว้ · แนะนำเปิดเพื่อความปลอดภัยบัญชี</> },
    ],
  },
  {
