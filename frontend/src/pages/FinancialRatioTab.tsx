...
const FALLBACK_ADVICE: Record<string, Record<string, string>> = {
  ...
  ratio2: { good: 'มีเงินสำรองฉุกเฉิน 3–6 เดือนตามเกณฑ์มาตรฐาน', warning: 'เงินสำรองฉุกเฉินยังน้อยกว่า 3 เดือน ควรทยอยสะสมให้ถึง 3–6 เท่าของรายจ่าย', danger: 'เงินสำรองฉุกเฉินไม่เพียงพอ ควรเร่งสะสมเงินสดให้ได้อย่างน้อย 3 เดือนของรายจ่าย' },
  ...
  ratio7: { good: 'อัตราการออมถึงเกณฑ์มาตรฐาน (≥ 10% ของรายได้)', warning: 'อัตราการออมยังต่ำกว่า 10% ควรตั้งเป้าออมอัตโนมัติเพิ่มขึ้น', danger: 'อัตราการออมต่ำมาก ควรทบทวนรายจ่ายและเริ่มออมอย่างมีวินัย' },
...
const RATIO_META: Record<string, {
  ...
  ratio6: { name: 'การชำระคืนหนี้ที่ไม่จดจำนอง',           formula: '(บัตรเครดิต + สินเชื่อส่วนบุคคล + วงเงิน OD + หนี้การศึกษา) / รายรับต่อเดือน',   standard: '< 15–20%',   unit: 'pct' },
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ padding: '12px 16px', background: 'rgba(59,130,246,0.06)',
        ...
        ข้อมูลคำนวณจากงบดุลส่วนบุคคลและงบกระแสเงินสดแบบเรียลไทม์ · ตามหลักการวางแผนการเงินแบบองค์รวม
      </div>
